...
public class ValidarAutomobile {
    ...
    public void selecionoNoCampoNumberOfSeatsONumero() throws Throwable {
        cadEnterVehicle.selecionarNumberSeats1("2");
    }
    ...
    @Test
    @Order(29)
    public void selecionoNoCampoMeritRatingOValor() throws Throwable {
        cadEnterProduct.selecionarMerit("Bonus 1");
    }

    @Test
    @Order(30)
    public void selecionoNoCampoDamageInsuranceOValor() throws Throwable {
        cadEnterProduct.selecionarDamage("Full Coverage");
    }

    @Test
    @Order(31)
    public void selecionoNoCampoOptionalProductsOValorDaOpcaoAutomobile() {
        cadEnterProduct.clicarOpctionalProduct("Euro Protection");
    }

    @Test
    @Order(32)
    public void selecionoNoCampoCourtesyCarOValor() throws Throwable {
        cadEnterProduct.selecionarCourtesy("Yes");
    }
