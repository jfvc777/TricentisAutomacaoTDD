...
public class ValidarTruck {
    ...
    public void quando_selecionamos_Motorcycle() {
        cadastrarSeguroPO.clicarOpcao("Truck");
    }
    ...
    public void e_seleciono_no_campo_Make_a_marca() {
        cadEnterVehicle.selecionarMake("Ford");
    }
    ...
    public void e_preencho_No_Campo_Date_Of_ManufactureA_Data() throws Throwable {
        cadEnterVehicle.preencherDateManuFacture("10/05/2020");
    }

    @Test
    @Order(6)
    public void selecionoNoCampoNumberOfSeatsONumero() throws Throwable {
        cadEnterVehicle.selecionarNumberSeats1("9");
    }
    ...
    public void preenchoNoCampoTotalWeightOValor() throws Throwable {
        cadEnterVehicle.preencherTotalWeight("100");
    }
    ...
    public void selecionoNoCampoInsuranceSumOValor() throws Throwable {
        cadEnterProduct.selecionarInsurance("15.000.000,00");
    }
