...
public class ValidarCamper {
    ...
    @Test
    @Order(1)
    public void quando_selecionamos_Camper() {
        cadastrarSeguroPO.clicarOpcao("Camper");
    }
    ...
    public void e_seleciono_no_campo_Make_a_marca() {
        cadEnterVehicle.selecionarMake("Honda");
    }
    ...
    public void e_preencho_No_Campo_Date_Of_ManufactureA_Data() throws Throwable {
        cadEnterVehicle.preencherDateManuFacture("10/16/2020");
    }

    @Test
    @Order(6)
    public void selecionoNoCampoNumberOfSeatsONumero() throws Throwable {
        cadEnterVehicle.selecionarNumberSeats1("8");
    }

    @Test
    @Order(7)
    public void selecionoNoCampoRightHandDriveOValorNaOpcaoCamper() {
        cadEnterVehicle.clicarOpcaoRightCamper("No");
    }

    @Test
    @Order(8)
    public void selecionoNoCampoFuelTypeOValor() throws Throwable {
        cadEnterVehicle.selecionarFuelType("Gas");
    }

    @Test
    @Order(9)
    public void preenchoNoCampoPayloadOValor() throws Throwable {
        cadEnterVehicle.preencherPayload("1000");
    }

    @Test
    @Order(10)
    public void preenchoNoCampoTotalWeightOValor() throws Throwable {
        cadEnterVehicle.preencherTotalWeight("50000");
    }
    ...
    @Test
    @Order(12)
    public void preenchoNoCampoLicensePlateNumberOValor() throws Throwable {
        cadEnterVehicle.preencherLicensePlate("A23A1");
    }
    ...
    public void selecionoNoCampoInsuranceSumOValor() throws Throwable {
        cadEnterProduct.selecionarInsurance("3.000.000,00");
    }

    @Test
    @Order(32)
    public void selecionoNoCampoDamageInsuranceOValor() throws Throwable {
        cadEnterProduct.selecionarDamage("No Coverage");
    }

    @Test
    @Order(33)
    public void selecionoNoCampoOptionalProductsOValor() {
        cadEnterProduct.clicarOpctionalProductTruck("Legal Defense Insurance");
    }
    @Test
    @Order(34)
